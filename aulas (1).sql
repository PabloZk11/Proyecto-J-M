-- Active: 1693512653666@@127.0.0.1@3306@aulas
-- phpMyAdmin SQL Dump
-- version 5.2.0
...
ALTER TABLE usuario ADD FOREIGN KEY (id_tdoc_usuario) REFERENCES validacion_documento(id_documento);

ALTER TABLE administrador ADD FOREIGN KEY (id_admin,id_tdoc_admin) REFERENCES usuario(id_usuario,id_tdoc_usuario);

ALTER TABLE proveedores ADD FOREIGN KEY (id_proveedor,id_tdoc_proveedor) REFERENCES usuario(id_usuario,id_tdoc_usuario);


ALTER TABLE vendedor ADD FOREIGN KEY (id_usuario_papeleria,id_tdoc_vendedor) REFERENCES usuario(id_usuario,id_tdoc_usuario);


ALTER TABLE informes ADD FOREIGN KEY (id_vendedor_informe) REFERENCES vendedor(id_usuario_papeleria);

ALTER TABLE factura ADD FOREIGN KEY (id_vendedor_factura,id_tdoc_vendedor_factura) REFERENCES vendedor(id_usuario_papeleria,id_tdoc_vendedor);


ALTER TABLE detalles_factura ADD FOREIGN KEY (id_factura_detalle) REFERENCES factura(id_factura);

ALTER TABLE detalles_factura ADD FOREIGN KEY (id_producto_detalle) REFERENCES  productos(id_producto);

ALTER TABLE pedidos ADD FOREIGN KEY (id_admin_pedido) REFERENCES administrador(id_admin);

ALTER TABLE pedidos ADD FOREIGN KEY (id_proveedor_pedido) REFERENCES proveedores(id_proveedor);

ALTER TABLE entradas_mercacia ADD FOREIGN KEY (id_pedido_entrada) REFERENCES pedidos(id_pedido);

ALTER TABLE entradas_mercacia ADD FOREIGN KEY (id_proveedor_entrada) REFERENCES proveedores(id_proveedor);

ALTER TABLE registro_salidas ADD FOREIGN KEY (id_factura_salidas) REFERENCEs factura(id_factura);

ALTER TABLE devoluciones ADD FOREIGN KEY (id_entrada_devolucion) REFERENCES entradas_mercacia(id_entrada);

ALTER TABLE detalles_pedido_productos ADD FOREIGN KEY (id_pedido_detalle) REFERENCES pedidos(id_pedido);

ALTER TABLE detalles_pedido_productos ADD FOREIGN KEY (id_producto_detalle) REFERENCES productos(id_producto);

ALTER TABLE detalles_entrada_mercancia ADD FOREIGN KEY (id_mercancia_detalle) REFERENCES entradas_mercacia(id_entrada);
ALTER TABLE detalles_entrada_mercancia ADD FOREIGN KEY (id_producto_detalle) REFERENCES productos(id_producto);