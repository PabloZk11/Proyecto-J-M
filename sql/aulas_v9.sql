...
-- Tiempo de generación: 26-11-2023 a las 20:53:11
...
INSERT INTO `factura` (`id_factura`, `id_tdoc_vendedor_factura`, `id_vendedor_factura`, `descripcion`, `fecha`) VALUES
...
--
ALTER TABLE `detalle_factura`
  ADD CONSTRAINT `detalle_factura_ibfk_1` FOREIGN KEY (`id_factura_detalle`) REFERENCES `factura` (`id_factura`),
  ADD CONSTRAINT `detalle_factura_ibfk_2` FOREIGN KEY (`id_producto_detalle`) REFERENCES `producto` (`id_producto`),
  ADD CONSTRAINT `detalle_factura_ibfk_3` FOREIGN KEY (`id_factura_detalle`) REFERENCES `factura` (`id_factura`),
...
ALTER TABLE `factura`
  ...
  ADD CONSTRAINT `factura_ibfk_2` FOREIGN KEY (`id_vendedor_factura`,`id_tdoc_vendedor_factura`) REFERENCES `vendedor` (`id_usuario_papeleria`, `id_tdoc_vendedor`);
...
--
ALTER TABLE `registro_salida`
  ADD CONSTRAINT `registro_salida_ibfk_1` FOREIGN KEY (`id_factura_salidas`) REFERENCES `factura` (`id_factura`);
